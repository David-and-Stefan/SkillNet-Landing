  ...
  return (
    <div className="flex flex-col justify-center items-center">
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md flex flex-col justify-center items-center text-center">
            ...
            <p className="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">
              Read what our users are saying about SkillNet
            </p>
      ...
      <figure className="max-w-screen-md mx-auto text-center">
        ...
        <blockquote>
          <p className="text-2xl italic font-medium text-gray-900 dark:text-white">
            "SkillNet has made organizing my lessons and managing student groups
            so much easier. It's a game-changer for teachers like me!"
          </p>
        </blockquote>
      ...
      <figure className="max-w-screen-md mx-auto text-center mb-10">
        ...
        <blockquote>
          <p className="text-2xl italic font-medium text-gray-900 dark:text-white">
            "As a student, I love how easy it is to join groups and stay
            connected with activities. SkillNet keeps everything organized for
            me."
          </p>
        </blockquote>
        <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
