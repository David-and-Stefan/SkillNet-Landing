    ...
    return (
        <footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800 flex flex-col justify-center items-center">
            ...
            <div className="mx-auto max-w-screen-xl text-center flex flex-col justify-center items-center">
                ...
                <p className="my-3 text-gray-500 dark:text-gray-400">support@skillnet.com</p>
                ...
                <p className="text-sm text-gray-400">Hauptstraße 15, 10115 Berlin, Germany</p>
                <p className="text-sm text-gray-400">Authorized representative: Max Mustermann</p>
                <p className="mb-3 text-sm text-gray-400">VAT ID number per § 27a UStG: DE123456789</p>
                <span className="text-sm text-gray-400 sm:text-center">SkillNet © 2024 All Rights Reserved</span>
            </div>
        </footer>
    );
}
